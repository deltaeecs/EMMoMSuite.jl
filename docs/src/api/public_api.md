...
| **快速算法** | `MLFMAOperator`, `MLFMAOperatorMPI`, `ACAOperator`, `MLACAOperator`, `aca`, `recompress!`, `LowRankBlock`, `BlockEvaluator`, `PMCHWBlockEvaluator`, `eval_block`, `BlockLUFactorization`, `block_lu`, `block_lu_solve`, `get_leaf_intervals` |
