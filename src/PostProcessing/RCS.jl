...
using ..CurrentOnGeos
using ..RadiationIntegral: r̂θϕInfo, raditionalIntegralNθϕCal, radiation_integral_rwg, radiation_integral_swg, ∠Info
...
function radarCrossSection(θs_obs::Vector{FT}, ϕs_obs::Vector{FT}, 
                           ICoeff::Vector{CT}, basis::RWGBasis{IT, FT}) where {IT<:Integer, FT<:Real, CT<:Complex{FT}}
...
"""
function radarCrossSection(θs_obs::Vector{FT}, ϕs_obs::Vector{FT}, 
                           ICoeff::Vector{CT}, basis::SWGBasis{IT, FT}, permittivities::Vector{CT}) where {IT<:Integer, FT<:Real, CT<:Complex{FT}}
