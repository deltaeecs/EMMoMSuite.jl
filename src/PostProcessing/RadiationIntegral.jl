...
function raditionalIntegralNθϕCal(
    r̂θϕ::r̂θϕInfo{FT},
    trianglesInfo::AbstractVector{TriangleInfo{IT,FT}},
    Jtris::AbstractMatrix{CT},
) where {IT<:Integer,FT<:Real,CT<:Complex{FT}}
...
"""
function radiation_integral_rwg(
    r̂θϕ::r̂θϕInfo{FT},
...
"""
function radiation_integral_swg(
    r̂θϕ::r̂θϕInfo{FT},
    basis::SWGBasis{IT,FT},
    ICoeff::Vector{CT},
...
"""
function radiation_integral_pwc(
    r̂θϕ::r̂θϕInfo{FT},
...
"""
function radiation_integral_pwc_hex(
    r̂θϕ::r̂θϕInfo{FT},
    ...
    for h = 1:nhex
        ...
        v_idx = hexas_elem[:, h]
        hex_verts = hcat([nodes[:, v_idx[i]] for i = 1:8]...)
...
"""
function radiation_integral_rbf(
    r̂θϕ::r̂θϕInfo{FT},
