...
function add_received_field_rwg!(
    ZI,
    bfID,
    basis,
    bf,
        ...
        for i_qp = 1:n_qp
            ...
            for iPole = 1:nPoles
                ...
                if is_cfie
                    ...
                    val +=
                        (alpha * term_efie + (1 - alpha) * eta * term_mfie) *
                        efie_factor *
                        factor_vec
                elseif is_mfie
...
function add_received_field_swg!(
    ZI,
    bfID,
    basis,
    bf,
