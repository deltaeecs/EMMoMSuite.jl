...
function efie_interaction!(Z_local::AbstractMatrix{CT}, efie::EFIE{FT, CT}, tri_test::TriangleInfo{IT, FT}, tri_source::TriangleInfo{IT, FT}) where {IT, FT, CT}
...
function efie_interaction!(Z_local::Matrix{CT}, efie::EFIE{FT, CT}, tri_test::TriangleInfo{IT, FT}, tri_source::TriangleInfo{IT, FT}, quad_points::Vector) where {IT, FT, CT}
...
function efie_interaction!(Z_local::AbstractMatrix{CT}, efie::EFIE{FT, CT}, tri_test::TriangleInfo{IT, FT}, tri_source::TriangleInfo{IT, FT}, r_test, r_src) where {IT, FT, CT}
...
function calc_self_interaction!(Z_local::AbstractMatrix{CT}, efie::EFIE{FT, CT}, tri::TriangleInfo{IT, FT}) where {IT, FT, CT}
    gq = efie.gq_near
...
function calc_near_interaction!(Z_local::AbstractMatrix{CT}, efie::EFIE{FT, CT}, tri_test::TriangleInfo{IT, FT}, tri_source::TriangleInfo{IT, FT}) where {IT, FT, CT}
    gq = efie.gq_near
    C4divk2 = efie.C4divk2
    ...
    for i in 1:length(w_test)
        ...
        Ig, IvecSg = faceSingularityIgIvecg(ri, tri_source.vertices, 
                                           tri_source.edgel, tri_source.edgev̂, 
                                           tri_source.edgen̂, tri_source.area, 
                                           tri_source.facen̂, efie.SSCg)
